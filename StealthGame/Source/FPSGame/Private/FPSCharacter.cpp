...
AFPSCharacter::AFPSCharacter()
{
	...
	m_noiseEmitterComponent = CreateDefaultSubobject<UPawnNoiseEmitterComponent>(TEXT("NoiseEmitter"));
}
...
void AFPSCharacter::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	//DOREPLIFETIME_CONDITION(AFPSCharacter, IsCarryingObjective, ELifetimeCondition::COND_InitialOnly)
}